(* Expressions and contexts isomorphic to those defined in cps.v and ctx.v.
   ...
   - The MetaCoq in Prototype.v doesn't support treating AST types defined with type aliases
     like [var] and [fun_tag] differently. This version of the AST wraps them in singleton
     inductives.
   - Even if it were OK to these types the same, rewriting the definition of [exp] to use
