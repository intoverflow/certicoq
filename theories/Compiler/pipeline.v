...
Fixpoint find_prim_arrities (env : Ast.global_env) (prs : list (kername * string * bool)) : error (list (kername * string * bool * nat * positive)) :=
  match prs with
  | [] => Ret []
  | ((pr, s), b) :: prs =>
...
Definition register_prims (id : positive) (env : Ast.global_env) : pipelineM (list (kername * string * bool * nat * positive) * positive) :=
  o <- get_options ;;
